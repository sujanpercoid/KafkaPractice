...
public class MyDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Data Source=DESKTOP-SUJAN\\PERCOIDDB;Initial Catalog=KafkaConsumer2;Integrated Security=True;TrustServerCertificate=True;");
    }
}
...
public class KafkaConsumerrr
{
    ...
    public static void ReadMessage()
    {
        ...
        consumer.Subscribe("new_topic_testing");
